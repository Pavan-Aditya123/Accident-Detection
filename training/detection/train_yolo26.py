...
def main():
    ...
    # Dataset path
    data_yaml = base_dir / "datasets" / "accident_detection" / "data.yaml"

    # Results directory
    project_dir = base_dir / "results" / "detection"

    print("=" * 60)
    print("       YOLO26 BASELINE ACCIDENT DETECTION TRAINING")
    print("=" * 60)

    print(f"[+] Repository Root   : {base_dir}")
    print(f"[+] Dataset Config    : {data_yaml}")
    print(f"[+] Output Directory  : {project_dir / 'yolo26_baseline'}")
    ...
    output_dir = project_dir / "yolo26_baseline"
